package com.example.quiztime.Adapter
...
import com.example.quiztime.databinding.ViewholderLeaderBinding
...
class LeaderAdapter : RecyclerView.Adapter<LeaderAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: LeaderAdapter.ViewHolder, position: Int) {
        ...
        val drawableResourceId: Int = binding.root.resources.getIdentifier(differ.currentList[position].pic,"drawable",binding.root.context.packageName)
